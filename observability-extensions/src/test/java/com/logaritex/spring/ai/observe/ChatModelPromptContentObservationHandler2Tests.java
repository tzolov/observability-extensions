 ...
 */
class ChatModelPromptContentObservationHandler2Tests {
	...
	void whenPromptWithTextThenSpanEvent() {
		...
		new ChatModelPromptContentObservationHandler2().onStop(observationContext);
		...
		assertThat(spanData.getEvents().get(0).getAttributes().get(AttributeKey.stringArrayKey("gen_ai.prompt")))
